...
func TestGet(t *testing.T) {
	t.Run("Happy", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodGet, "/lightnet-gogo", "random-uuid")
	...
	t.Run("Happy - context GinContextKey but there's no correlation id in the header", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodGet, "/lightnet-gogo", "")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
...
func TestPost(t *testing.T) {
	t.Run("Happy - without body", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodPost, "/lightnet-gogo", "random-uuid")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
	...
	t.Run("Happy - context GinContextKey but there's no correlation id in the header", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodPost, "/lightnet-gogo", "")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
...
func TestPut(t *testing.T) {
	t.Run("Happy - without body", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodPut, "/lightnet-gogo", "random-uuid")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
	...
	t.Run("Happy - context GinContextKey but there's no correlation id in the header", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodPut, "/lightnet-gogo", "")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
...
func TestDelete(t *testing.T) {
	t.Run("Happy - without body", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodDelete, "/lightnet-gogo", "random-uuid")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
	...
	t.Run("Happy - context GinContextKey but there's no correlation id in the header", func(t *testing.T) {
		...
		gc := createGinContextWithCorrelationId(http.MethodDelete, "/lightnet-gogo", "")
		ctx := context.WithValue(context.TODO(), GinContextKey, gc)
